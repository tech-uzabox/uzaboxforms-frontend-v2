...
const AdminPendingProcesses: React.FC = () => {
  ...
  return (
    <ProcessDetailList
      ...
      isError={isError}
      processId={processId}
      title={t('processManagement.pendingApplicationsAdminView')}
      loadingMessage={t('processManagement.loading')}
      errorMessage={t('processManagement.errorLoadingData')}
      noDataMessage={t('processManagement.noPendingApplicationsFound')}
...
export default AdminPendingProcesses;           