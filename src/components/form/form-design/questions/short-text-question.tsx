...
export const ShortTextQuestion: React.FC<QuestionItemProps> = ({ question, sectionIndex, questionIndex, isMinimized }) => {
        ...
        <>
          ...
          <div className='question-container'>
            ...
            <input
              ...
              onChange={handleChange}
              className="main-input"
              placeholder={t('questionDesign.maximumCharacters')}
            />
          </div>
        </>
      )}
